...
function _getCuotasCfg(){
  try{ return JSON.parse(dbGetConfig('gomCuotas')||'{}'); }catch(e){ return {}; }
}
...
async function _guardarCuotasCfg(){
  ...
  dbSetConfig('gomCuotas', JSON.stringify({c3,c6,c12}));
  // actualizar ejemplo
  const e = 100000;
...
function _getGomMarcas(){ try{ return JSON.parse(dbGetConfig('gomMarcas')||'null')||_GOM_MARCAS_DEF; }catch(e){ return _GOM_MARCAS_DEF; } }
function _getGomServicios(){ try{ return JSON.parse(dbGetConfig('gomServicios')||'null')||_GOM_SERV_DEF; }catch(e){ return _GOM_SERV_DEF; } }
function _saveGomMarcas(l){ dbSetConfig('gomMarcas', JSON.stringify(l)); }
function _saveGomServicios(l){ dbSetConfig('gomServicios', JSON.stringify(l)); }
